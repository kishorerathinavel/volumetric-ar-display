...
for subvolume_append = 1:NumofBP-1 
    ...
    nLEDs = non_zero_mean(toOptimize); % Document
    nLEDs(isnan(nLEDs)) = 0;
    ...
    nLEDs = non_zero_minimum(toOptimize2); % Document
    nLEDs(isnan(nLEDs)) = 0;
    ...
    nLEDs = non_zero_minimum(toOptimize3); % Document
    nLEDs(isnan(nLEDs)) = 0;
    ...
    nLEDs = non_zero_minimum(toOptimize4); % Document
    nLEDs(isnan(nLEDs)) = 0;
