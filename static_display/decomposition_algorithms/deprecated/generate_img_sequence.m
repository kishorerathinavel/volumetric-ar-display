function [Image_sequence,Image_CutVol]=generate_image_sequence(varargin)
...
DepthMap_norm=depth_map_normalization(DepthMap_re);
NumofCP=NumofBP-colorbit+1;

DepthList=generate_depth_list(NumofBP,NumofCP,colorbit); 

[Image_sequence,Image_CutVol]=generate_image_sequence(RGBImg_re,DepthMap_norm,DepthList,NumofBP, NumofCP,colorbit,RGB_BR,Isize,DepthBG); 
...
%--------------------------------------------------------------------------
function [Image_sequence,Image_CutVol]=generate_image_sequence(RGBImg_re,DepthImg_norm,DepthList,NumofBP,NumofCP,colorbit,RGB_BR,Isize,DepthBG)
