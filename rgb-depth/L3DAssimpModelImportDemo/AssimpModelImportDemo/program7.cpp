...
program7_class::program7_class() {
	// Shader Names
	this->fname_vertex_shader = "synthetic1.vert";
	this->fname_fragment_shader = "presentation.frag";
}
...
void program7_class::delayed_init() {
...
GLuint program7_class::setup_shaders() {
